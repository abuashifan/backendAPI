...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('vendor_invoice_lines', function (Blueprint $table) {
            $table->bigIncrements('id')->comment('Primary key invoice line');
            ...
            $table->index('vendor_invoice_id', 'idx_vi_line_invoice');
            $table->index('product_id', 'idx_vi_line_product');
            $table->index('tax_id', 'idx_vi_line_tax');
        });
    }
